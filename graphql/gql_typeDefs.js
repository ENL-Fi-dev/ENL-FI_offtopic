...
const typeDefs = gql`
    ...
    type Query {
        ...
        users(token: String!, active: Boolean, username: String, role: String): [EnlUser!]!
        groupCount: Int!
        groups: [TgGroup!]!
        news: [News!]!
    }
    type Mutation {
        ...
        addGroup(token: String!, title: String!): TgGroup!,
        updateGroup(token: String!, id: String!, title: String, active: Boolean): TgGroup!,
